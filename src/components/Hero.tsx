...
const Hero: React.FC = () => {
  ...
  return (
    <div 
      ...
      style={{ 
        backgroundImage: 'url("https://images.unsplash.com/photo-1569383746724-6f1b85122541?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80")',
      }}
    >
